...
API_KEY = os.getenv("TWELVELABS_KEY")
INDEX_NAME = "FINAL22"
...
def generate_data(VIDEO_PATH, QUERY_TEXT = QUERY_TEXT, API_KEY=API_KEY, INDEX_NAME=INDEX_NAME, VIDEO_UPLOAD = 0, TOPK = 5, DELETE = True):
    if DELETE:  
